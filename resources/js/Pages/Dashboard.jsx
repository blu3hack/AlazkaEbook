...
export default function Dashboard({ auth, totalUsers, totalEbooks }) {
    // State for controlling modal visibility
    const [isModalOpen, setIsModalOpen] = useState(false);
    const maxMultiplier = Math.floor(totalUsers / totalEbooks);
    const randomMultiplier = Math.floor(Math.random() * maxMultiplier) + 1;

    const safeValue = totalEbooks * randomMultiplier;
