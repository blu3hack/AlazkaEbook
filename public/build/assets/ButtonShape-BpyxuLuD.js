import{j as e}from"./app-BLQPorN4.js";function l({label:a,icon:r,color:t,gradientFrom:o,gradientTo:s,onClick:i}){return e.jsx("button",{onClick:i,className:"group relative overflow-hidden",children:e.jsxs("div",{className:`relative flex flex-col items-center gap-2 px-6 py-5 
